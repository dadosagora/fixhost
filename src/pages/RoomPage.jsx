...
export default function RoomPage() {
  ...
  const [form, setForm] = useState({ code: "", floor: 1, type: "standard", notes: "" });
  ...
  async function createRoom(e) {
    ...
    setShowForm(false);
    setForm({ code: "", floor: 1, type: "standard", notes: "" });
    await load();
    alert("Quarto criado ✅");
  }
          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-lg p-4 space-y-4">
            ...
            <form onSubmit={createRoom} className="space-y-3">
              ...
              <div className="flex justify-end gap-2">
                <button type="button" className="border rounded-lg px-3 py-2" onClick={() => setShowForm(false)}>
                  Cancelar
                </button>
